...
\begin{enumerate}
    ...
    \item Bagaimana cara penentuan bagian label dan data pada \textit{spreadsheet} untuk dijadikan skema relasi?
    \item Bagaimana cara melakukan penyimpanan data yang telah dibuat?
    \item Bagaimana perubahan alur kerja yang terjadi akibat penggunaan kakas yang dibuat?
\end{enumerate}

\section{Tujuan}

Tujuan yang ingin dicapai dalam Tugas Akhir ini adalah mengembangkan perangkat lunak pengumpulan data berbentuk \textit{spreadsheet} yang dapat melakukan validasi dan menemukan kesalahan pada data masukan. Dengan adanya perangkat lunak ini diharapkan dapat memvalidasi data masukan dengan lebih baik dan diharapkan mempercepat pengumpulan data.
...
\begin{enumerate}
    ...
    \item Hasil akhir dari kakas disimpan dalam bentuk basis data.
...
\begin{enumerate}
    ...
    Pada tahap ini dilakukan analisis permasalahan yang berkaitan dengan topik yang diangkat pada tugas akhir ini. Di samping itu, dilakukan penentuan spesifikasi dan fitur yang ada pada kakas tersebut sebagai bentuk solusi terhadap permasalahan yang dianalisis.
