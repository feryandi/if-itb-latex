...
%--------------------------------------------------------------------%
%
% Berkas ini berisi struktur utama dokumen LaTeaX yang akan dibuat.
%
%--------------------------------------------------------------------%
...
\begin{document}
    ...
    {%
        \let\oldnumberline\numberline%
        \renewcommand{\numberline}{\appendixname~\oldnumberline}%
        \listofappendices%
    }
    ...
    \titleformat{\chapter}[hang]
      {\Large\bfseries}{\chaptertitlename\ \thechapter.\ }{0pt}{\Large\bfseries}
